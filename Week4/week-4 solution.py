...
def insert_record():
    c.execute('''insert into contact_tbl values('Jay','Patel',9867890543,'jay@gmail.com','Mumbai'),
                                               ('Shree','patil',9812390543,'shree@gmail.com','Delhi'),
                                               ('Ram','chauhan',9867890999,'ram@gmail.com','Delhi'),
                                               ('Shiv','patil',9998909992,'shiv@gmail.com','Surat'),
...
def update_record():
    upq=""" update contact_tbl
            ...
            where fname='Shiv' and lname='patil';
        """
    c.execute(upq)
...
def delete_record():
    delq="""
             ...
             where fname='Shree' and lname='patil';
         """
    c.execute(delq)
